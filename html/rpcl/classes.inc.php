 ...
 *
 */
class Filer extends ObjectNew1
{
 ...
 */
class Collection extends ObjectNew1
{
        //Items array
        public $items;
         ...
         * @see delete()
         *
         * @param mixed $item ObjectNew1 to add to the list
 ...
 *
 */
class Persistent extends ObjectNew1
{
                /**
        ...
        */
         ...
         *
         * @param Persistent $source ObjectNew1 to get assigned to this object
         */
         ...
         *
         * @param Persistent $dest ObjectNew1 to assign this object to
         */
         ...
         *
         * It uses PHP reflection to get the published properties that will be stored. ObjectNew1
         ...
         *
         * @throws    Exception       ObjectNew1 owner is not set.
         */
        function serialize()
        {
