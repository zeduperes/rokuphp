...
class DataModule extends CustomPage
{
        ...
        * @see extractjscript()
        *
        * @param object $object ObjectNew1 to be added
        */
 ...
 * @param string $sender ObjectNew1 that produced the ajaxCall
...
class CustomForm extends CustomPage
{
    ...
    /**
     * Triggered once the page is completely loaded,  and the DOM (http://en.wikipedia.org/wiki/Document_ObjectNew1_Model) is
 ...
 */
    ...
    */
    ...
    function dumpJavascript()
    {
      ...
      echo "var $this->Name=new ObjectNew1(ObjectNew1);\n\n";
