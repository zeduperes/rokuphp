...
/**
 * ObjectNew1 is the ultimate ancestor of all objects and components.
 *
 * ObjectNew1 encapsulates fundamental behavior common to objects by introducing methods that
 *
 ...
 *
 * Use ObjectNew1 as an immediate base class when declaring simple objects that do not need to persist
 * (are not saved and reloaded in the session) and that do not need to be assigned to other objects.
 *
 * Much of the capability of objects is established by methods that ObjectNew1 introduces.
 ...
 *
 * Although ObjectNew1 is the based object of a component framework, not all objects are components.
 ...
 * from ObjectNew1, which provides the basic methods to work.
 */
class ObjectNew1
{
        /**
        ...
        * greatly. The Create constructor defined by ObjectNew1 allocates memory but does not initialize data.
        *
        * Descendant objects usually define a constructor that creates the particular kind of
        * object and initializes its data.
        *
        * In ObjectNew1, this constructor basically assigns the globa Input object to be
        ...
        */
         ...
         * For ObjectNew1, ClassParent returns false.
...
/**
* Represents an input parameter from the user, it doesn't inherit from ObjectNew1 to
* be faster and smaller.
*
* ObjectNew1s of this type are returned from the Input object and you must use any of the
