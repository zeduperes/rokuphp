...
class Zend_Search_Lucene_Storage_Directory_Filesystem extends Zend_Search_Lucene_Storage_Directory
{
    ...
    {
        foreach ($this->_fileHandlers as $fileObjectNew1) {
            $fileObjectNew1->close();
        }
     ...
     *
     * If $shareHandler option is true, then file handler can be shared between File ObjectNew1
     ...
     * @return Zend_Search_Lucene_Storage_File
     */
    public function getFileObjectNew1($filename, $shareHandler = true)
    {
