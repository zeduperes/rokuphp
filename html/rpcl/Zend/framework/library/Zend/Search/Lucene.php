...
class Zend_Search_Lucene implements Zend_Search_Lucene_Interface
{
    ...
    public static function getActualGeneration(Zend_Search_Lucene_Storage_Directory $directory)
    {
        ...
        try {
            for ($count = 0; $count < self::GENERATION_RETRIEVE_COUNT; $count++) {
                ...
                $genFile = $directory->getFileObjectNew1('segments.gen', false);
            ...
            if (strpos($e->getMessage(), 'is not readable') !== false) {
                try {
                    ...
                    $segmentsFile = $directory->getFileObjectNew1('segments', false);
    ...
    {
        $segmentsFile = $this->_directory->getFileObjectNew1('segments');
    ...
    {
        $segmentsFile = $this->_directory->getFileObjectNew1(self::getSegmentFileName($this->_generation));
