...
class Zend_Pdf_Element_Reference extends Zend_Pdf_Element
{
    ...
    {
        if (($obj = $this->_factory->fetchObjectNew1($this->_objNum . ' ' . $this->_genNum)) === null) {
            $obj = $this->_context->getParser()->getObjectNew1(
    ...
    public function makeClone(Zend_Pdf_ElementFactory $factory, array &$processed, $mode)
    {
        ...
        // This code duplicates code in Zend_Pdf_Element_ObjectNew1 class,
