 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_Pdf_Element_ObjectNew1_Stream extends Zend_Pdf_Element_ObjectNew1
{
    /**
     * StreamObjectNew1 dictionary
     * Required enries:
     * Length
     *
    ...
    public function makeClone(Zend_Pdf_ElementFactory $factory, array &$processed, $mode)
    {
        ...
        $processed[$id] = $clonedObjectNew1 = $factory->newStreamObjectNew1('');

        // Copy current object data and state
        $clonedObjectNew1->_dictionary            = $this->_dictionary->makeClone($factory, $processed, $mode);
        $clonedObjectNew1->_value                 = $this->_value->makeClone($factory, $processed, $mode);
        $clonedObjectNew1->_initialDictionaryData = $this->_initialDictionaryData;
        $clonedObjectNew1->_streamDecoded         = $this->_streamDecoded;

        return  $clonedObjectNew1;
    }
