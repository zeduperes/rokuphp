 ...
 * @version    $Id: ObjectNew1.php 23775 2011-03-01 17:25:24Z ralph $
 */
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_Pdf_Element_ObjectNew1 extends Zend_Pdf_Element
{
    /**
     * ObjectNew1 value
     *
    ...
    /**
     * ObjectNew1 number within PDF file
     *
     * @var integer
     */
    protected $_objNum;
    ...
    public function __construct(Zend_Pdf_Element $val, $objNum, $genNum, Zend_Pdf_ElementFactory $factory)
    {
        if ($val instanceof self) {
            ...
            throw new Zend_Pdf_Exception('ObjectNew1 number must not be an instance of Zend_Pdf_Element_ObjectNew1.');
        }

        if ( !(is_integer($objNum) && $objNum > 0) ) {
            require_once 'Zend/Pdf/Exception.php';
            throw new Zend_Pdf_Exception('ObjectNew1 number must be positive integer.');
        }
        ...
        $this->setParentObjectNew1($this);

        $factory->registerObjectNew1($this, $objNum . ' ' . $genNum);
    }
    ...
    public function makeClone(Zend_Pdf_ElementFactory $factory, array &$processed, $mode)
    {
        ...
        $processed[$id] = $clonedObjectNew1 = $factory->newObjectNew1(new Zend_Pdf_Element_Null());

        // Pecursively process actual data
        $clonedObjectNew1->_value = $this->_value->makeClone($factory, $processed, $mode);

        if ($clonedObjectNew1->_value instanceof Zend_Pdf_Element_Null) {
            ...
            return $clonedObjectNew1->_value;
        }
