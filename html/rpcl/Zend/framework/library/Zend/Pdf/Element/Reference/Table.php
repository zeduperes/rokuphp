...
class Zend_Pdf_Element_Reference_Table
{
    ...
    public function  __construct()
    {
        ...
        $this->_inuse  = array();  $this->_usedObjectNew1s = array();
    }
    ...
    public function addReference($ref, $offset, $inuse = true)
    {
        ...
        if ($inuse) {
            ...
            $this->_usedObjectNew1s[$objNum] = $objNum;
        } else {
    ...
    public function getNextFree($ref)
    {
        if (isset($this->_inuse[$ref])) {
            require_once 'Zend/Pdf/Exception.php';
            throw new Zend_Pdf_Exception('ObjectNew1 is not free');
        }
        ...
        require_once 'Zend/Pdf/Exception.php';
        throw new Zend_Pdf_Exception('ObjectNew1 not found.');
    }
    ...
    {
        if (isset($this->_usedObjectNew1s[$objNum])) {
            require_once 'Zend/Pdf/Exception.php';
            throw new Zend_Pdf_Exception('ObjectNew1 is not free');
        }
