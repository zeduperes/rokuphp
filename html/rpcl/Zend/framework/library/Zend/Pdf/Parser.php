...
class Zend_Pdf_Parser
{
    ...
    private function _loadXRefTable($offset)
    {
        ...
        if ($nextLexeme == 'xref') {
            ...
            $xrefStream = $this->_stringParser->getObjectNew1($offset, $context);

            if (!$xrefStream instanceof Zend_Pdf_Element_ObjectNew1_Stream) {
                require_once 'Zend/Pdf/Exception.php';
            ...
            for ($count = 0; $count < $sections; $count++) {
                ...
                for ($count2 = 0; $count2 < $entries; $count2++) {
                    ...
                    switch ($type) {
                        ...
                        case 2:
                            // ObjectNew1 in an object stream
                            // Debug output:
    ...
    public function __construct($source, Zend_Pdf_ElementFactory_Interface $factory, $load)
    {
        ...
        $factory->setObjectNew1Count($this->_trailer->Size->value);
    }
