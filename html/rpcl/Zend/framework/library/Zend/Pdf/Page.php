...
class Zend_Pdf_Page extends Zend_Pdf_Canvas_Abstract
{
  ...
  /* Line Dash Types */
     ...
     *
     * @var Zend_Pdf_Element_Reference|Zend_Pdf_Element_ObjectNew1
     */
     ...
     *    ObjectNew1 factory is created by PDF parser.
     * ---------------------------------------------------------
     ...
     *    New page is created in the same context as source page. ObjectNew1 factory is shared.
    ...
    public function __construct($param1, $param2 = null, $param3 = null)
    {
        if (($param1 instanceof Zend_Pdf_Element_Reference ||
             $param1 instanceof Zend_Pdf_Element_ObjectNew1
            ) &&
            ...
            $this->_dictionary = $this->_objFactory->newObjectNew1(new Zend_Pdf_Element_Dictionary());
    ...
    protected function _attachResource($type, Zend_Pdf_Resource $resource)
    {
        ...
        $resObjectNew1 = $resource->getResource();
        foreach ($this->_dictionary->Resources->$type->getKeys() as $ResID) {
            if ($this->_dictionary->Resources->$type->$ResID === $resObjectNew1) {
                return $ResID;
            }
        }
        ...
        $this->_dictionary->Resources->$type->$newResName = $resObjectNew1;
    ...
    public function __clone()
    {
        ...
        $this->_dictionary = $factory->newObjectNew1($dictionary);
    ...
    public function clonePage($factory, &$processed)
    {
        ...
        $clonedPage = new Zend_Pdf_Page($factory->newObjectNew1($dictionary), $factory);
    ...
    public function flush()
    {
        ...
        if ((!$this->_safeGS)  &&  (count($this->_dictionary->Contents->items) != 0)) {
            ...
            $newContentsArray->items[] = $this->_objFactory->newStreamObjectNew1(" q\n");
        ...
        $this->_dictionary->Contents->items[] =
                $this->_objFactory->newStreamObjectNew1($this->_contents);
    ...
    public function attachAnnotation(Zend_Pdf_Annotation $annotation)
    {
        ...
        if (!$annotationDictionary instanceof Zend_Pdf_Element_ObjectNew1  &&
            !$annotationDictionary instanceof Zend_Pdf_Element_Reference) {
            $annotationDictionary = $this->_objFactory->newObjectNew1($annotationDictionary);
        }
