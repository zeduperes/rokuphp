...
abstract class Zend_Pdf_Element
{
     ...
     *
     * @var Zend_Pdf_Element_ObjectNew1
     */
    private $_parentObjectNew1 = null;
     ...
     *
     * @todo It's nevessry to check if SplObjectNew1Storage class works faster
     ...
     *
     * @param Zend_Pdf_Element_ObjectNew1 $parent
     */
    public function setParentObjectNew1(Zend_Pdf_Element_ObjectNew1 $parent)
    {
        $this->_parentObjectNew1 = $parent;
    }
     ...
     */
    public function getParentObjectNew1()
    {
        return $this->_parentObjectNew1;
    }
    ...
    {
        if ($this->_parentObjectNew1 !== null) {
            $this->_parentObjectNew1->touch();
        }
    }
