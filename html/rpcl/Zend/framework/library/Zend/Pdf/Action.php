...
abstract class Zend_Pdf_Action extends Zend_Pdf_Target implements RecursiveIterator, Countable
{
     ...
     * Action dictionary
     *
     * @var Zend_Pdf_Element_Dictionary|Zend_Pdf_Element_ObjectNew1|Zend_Pdf_Element_Reference
     */
     ...
     * @param SplObjectNew1Storage            $processedActions  list of already processed action dictionaries, used to avoid cyclic references
     * @throws Zend_Pdf_Exception
     */
    public function __construct(Zend_Pdf_Element $dictionary, SplObjectNew1Storage $processedActions)
    {
        require_once 'Zend/Pdf/Element.php';
     ...
     *
     * @internal
     * @param Zend_Pdf_Element $dictionary (It's actually Dictionary or Dictionary ObjectNew1 or Reference to a Dictionary ObjectNew1)
     * @param SplObjectNew1Storage $processedActions  list of already processed action dictionaries, used to avoid cyclic references
     * @return Zend_Pdf_Action
     * @throws Zend_Pdf_Exception
     */
    public static function load(Zend_Pdf_Element $dictionary, SplObjectNew1Storage $processedActions = null)
    {
        if ($processedActions === null) {
            $processedActions = new SplObjectNew1Storage();
        }
     ...
     *
     * @internal
     * @param Zend_Pdf_ElementFactory $factory   ObjectNew1 factory for newly created indirect objects
     * @param SplObjectNew1Storage $processedActions  list of already processed actions (used to prevent infinity loop caused by cyclic references)
     * @return Zend_Pdf_Element_ObjectNew1|Zend_Pdf_Element_Reference   Dictionary indirect object
     */
    public function dumpAction(Zend_Pdf_ElementFactory_Interface $factory, SplObjectNew1Storage $processedActions = null)
    {
        if ($processedActions === null) {
            $processedActions = new SplObjectNew1Storage();
        }
        ...
        if ($this->_actionDictionary instanceof Zend_Pdf_Element_Dictionary) {
            ...
            return $factory->newObjectNew1($this->_actionDictionary);
        } else {
