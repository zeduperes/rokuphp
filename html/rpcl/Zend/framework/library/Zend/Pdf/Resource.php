...
abstract class Zend_Pdf_Resource
{
    ...
    {
        if ($resource instanceof Zend_Pdf_Element_ObjectNew1) {
        ...
        if ($resource instanceof Zend_Pdf_Element) {
            $this->_resource  = $this->_objectFactory->newObjectNew1($resource);
        } else {
            $this->_resource  = $this->_objectFactory->newStreamObjectNew1($resource);
        }
    }
...
//        }
//
//        $this->_pageDictionary = $factory->newObjectNew1($dictionary);
