...
class Zend_Pdf_Outline_Loaded extends Zend_Pdf_Outline
{
     ...
     * @param SplObjectNew1Storage $processedOutlines  List of already processed Outline dictionaries,
     *                                             used to avoid cyclic references
     * @return Zend_Pdf_Action
     * @throws Zend_Pdf_Exception
     */
    public function __construct(Zend_Pdf_Element $dictionary, SplObjectNew1Storage $processedDictionaries = null)
    {
        ...
        if ($dictionary->Count !== null) {
            ...
            $children = new SplObjectNew1Storage();
     ...
     * @param SplObjectNew1Storage $processedOutlines  List of already processed outlines
    ...
    public function dumpOutline(Zend_Pdf_ElementFactory_Interface $factory,
                                                 ...
                                                 SplObjectNew1Storage $processedOutlines = null)
    {
        if ($processedOutlines === null) {
            $processedOutlines = new SplObjectNew1Storage();
        }
