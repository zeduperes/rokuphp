    ...
    public function __construct($imageFileName)
    {
        ...
        switch ($color) {
            ...
            case Zend_Pdf_Resource_Image_Png::PNG_CHANNEL_INDEXED:
                ...
                $paletteObjectNew1 = $this->_objectFactory->newObjectNew1(new Zend_Pdf_Element_String_Binary($paletteData));
                $colorSpace->items[] = $paletteObjectNew1;
                break;
            ...
            case Zend_Pdf_Resource_Image_Png::PNG_CHANNEL_GRAY_ALPHA:
                ...
                $decodingStream = $decodingObjFactory->newStreamObjectNew1($imageData);
        ...
        if(!empty($smaskData)) {
             ...
             */
            $smaskStream = $this->_objectFactory->newStreamObjectNew1($smaskData);
            $smaskStream->dictionary->Type             = new Zend_Pdf_Element_Name('XObjectNew1');
