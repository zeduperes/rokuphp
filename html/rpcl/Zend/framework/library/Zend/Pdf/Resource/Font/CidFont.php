...
{
    /**
     * ObjectNew1 representing the font's cmap (character to glyph map).
     * @var Zend_Pdf_Cmap
     */
    ...
    public function __construct(Zend_Pdf_FileParser_Font_OpenType $fontParser)
    {
        ...
        $widthsObjectNew1 = $this->_objectFactory->newObjectNew1($widthsArrayElement);
        $this->_resource->W = $widthsObjectNew1;
        ...
        $cidSystemInfoObjectNew1            = $this->_objectFactory->newObjectNew1($cidSystemInfo);
        $this->_resource->CIDSystemInfo = $cidSystemInfoObjectNew1;
    }
