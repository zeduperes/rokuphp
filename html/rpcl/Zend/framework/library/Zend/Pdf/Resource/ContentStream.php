...
class Zend_Pdf_Resource_ContentStream extends Zend_Pdf_Resource
{
     ...
     *
     * @param Zend_Pdf_Element_ObjectNew1_Stream|string $contentStreamObjectNew1
     * @throws Zend_Pdf_Exception
     */
    public function __construct($contentStreamObjectNew1 = '')
    {
        if ($contentStreamObjectNew1 !== null &&
            !$contentStreamObjectNew1 instanceof Zend_Pdf_Element_ObjectNew1_Stream &&
            !is_string($contentStreamObjectNew1)
        ) {
            require_once 'Zend/Pdf/Exception.php';
            throw new Zend_Pdf_Exception('Content stream parameter must be a string or stream object');
        }

        parent::__construct($contentStreamObjectNew1);
    }
