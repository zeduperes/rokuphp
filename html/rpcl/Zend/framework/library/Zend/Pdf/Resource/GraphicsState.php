...
class Zend_Pdf_Resource_GraphicsState extends Zend_Pdf_Resource
{
     ...
     *
     * @param Zend_Pdf_Element_ObjectNew1 $extGStateObjectNew1
     * @throws Zend_Pdf_Exception
     */
    public function __construct(Zend_Pdf_Element_ObjectNew1 $extGStateObjectNew1 = null)
    {
        if ($extGStateObjectNew1 == null) {
            ...
            $extGStateObjectNew1 = $factory->newObjectNew1($gsDictionary);
        }

        if ($extGStateObjectNew1->getType() != Zend_Pdf_Element::TYPE_DICTIONARY) {
