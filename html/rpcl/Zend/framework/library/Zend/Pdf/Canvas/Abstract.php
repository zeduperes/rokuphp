...
abstract class Zend_Pdf_Canvas_Abstract implements Zend_Pdf_Canvas_Interface
{
    ...
    public function setAlpha($alpha, $mode = 'Normal')
    {
        ...
        $gStateNameObjectNew1 = new Zend_Pdf_Element_Name($gStateName);
        $this->_contents .= $gStateNameObjectNew1->toString() . " gs\n";
...
// ------------------------------------------------------------------------------------------
    ...
    public function drawImage(Zend_Pdf_Resource_Image $image, $x1, $y1, $x2, $y2)
    {
        ...
        $imageName    = $this->_attachResource('XObjectNew1', $image);
