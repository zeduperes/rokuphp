...
/**
 * @see Zend_Ldap_Node_Schema_ObjectNew1Class_ActiveDirectory
 */
require_once 'Zend/Ldap/Node/Schema/ObjectNew1Class/ActiveDirectory.php';
...
class Zend_Ldap_Node_Schema_ActiveDirectory extends Zend_Ldap_Node_Schema
{
    ...
    protected function _parseSchema(Zend_Ldap_Dn $dn, Zend_Ldap $ldap)
    {
        ...
        foreach ($ldap->search('(objectClass=classSchema)', $dn,
            ...
            $val = new Zend_Ldap_Node_Schema_ObjectNew1Class_ActiveDirectory($node);
