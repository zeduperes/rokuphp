...
/**
 * @see Zend_Ldap_Node_Schema_ObjectNew1Class_OpenLdap
 */
require_once 'Zend/Ldap/Node/Schema/ObjectNew1Class/OpenLdap.php';
...
class Zend_Ldap_Node_Schema_OpenLdap extends Zend_Ldap_Node_Schema
{
     ...
     * @return array
     */
    public function getObjectNew1Classes()
    {
     ...
     * @return void
     */
    protected function _loadObjectNew1Classes()
    {
        $this->_objectClasses = array();
        foreach ($this->getAttribute('objectClasses') as $value) {
            $val = $this->_parseObjectNew1Class($value);
            $val = new Zend_Ldap_Node_Schema_ObjectNew1Class_OpenLdap($val);
     ...
     * @return array
     */
    protected function _parseObjectNew1Class($value)
    {
        $objectClass = array(
            'oid'        => null,
            'name'       => null,
