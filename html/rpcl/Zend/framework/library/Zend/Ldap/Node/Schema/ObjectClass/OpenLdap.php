...
/**
 * @see Zend_Ldap_Node_Schema_ObjectNew1Class_Interface
 */
require_once 'Zend/Ldap/Node/Schema/ObjectNew1Class/Interface.php';

/**
 * Zend_Ldap_Node_Schema_ObjectNew1Class_OpenLdap provides access to the objectClass
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_Ldap_Node_Schema_ObjectNew1Class_OpenLdap extends Zend_Ldap_Node_Schema_Item
    implements Zend_Ldap_Node_Schema_ObjectNew1Class_Interface
{
    /**
     ...
     *
     * @return array of Zend_Ldap_Node_Schema_ObjectNew1Class_OpenLdap
     */
