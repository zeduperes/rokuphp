...
class Zend_Ldap_Converter
{
     ...
     * DateTime ObjectNew1, a string that is parseable by strtotime() or a Zend_Date
     * ObjectNew1.
     *
    ...
    /**
     * Convert an LDAP-Generalized-Time-entry into a DateTime-ObjectNew1
     *
     * CAVEAT: The DateTime-ObjectNew1 returned will alwasy be set to UTC-Timezone.
     *
    ...
    public static function fromLdapDateTime($date, $asUtc = true)
    {
        ...
        // Raw-Data is present, so lets create a DateTime-ObjectNew1 from it.
        $offset = $time['offdir']
