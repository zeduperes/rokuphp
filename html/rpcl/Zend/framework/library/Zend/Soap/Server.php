...
class Zend_Soap_Server implements Zend_Server_Interface
{
    ...
    /**
     * ObjectNew1 registered with this server
     */
    protected $_object;
     ...
     *
     * See {@link setObjectNew1()} to set preconfigured object instances as request handlers.
     *
     ...
     * @return Zend_Soap_Server
     */
    public function setObjectNew1($object)
    {
        if(!is_object($object)) {
            require_once 'Zend/Soap/Server/Exception.php';
    ...
    protected function _getSoap()
    {
        ...
        if (!empty($this->_object)) {
            $server->setObjectNew1($this->_object);
        }
