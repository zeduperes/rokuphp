...
//    }
    ...
    {
        $this->_client = $client;
        if ($this->isObjectNew1RegistryEnablable($this->_client)) {
            $this->enableRegistryOnObjectNew1($this->_client);
        }
        return $this;
    }
    ...
    {
        $this->_loader = $loader;
        if ($this->isObjectNew1RegistryEnablable($this->_loader)) {
            $this->enableRegistryOnObjectNew1($this->_loader);
        }
        return $this;
    }
    ...
    public function setActionRepository(Zend_Tool_Framework_Action_Repository $actionRepository)
    {
        ...
        if ($this->isObjectNew1RegistryEnablable($this->_actionRepository)) {
            $this->enableRegistryOnObjectNew1($this->_actionRepository);
        }
        return $this;
    }
    ...
    public function setProviderRepository(Zend_Tool_Framework_Provider_Repository $providerRepository)
    {
        ...
        if ($this->isObjectNew1RegistryEnablable($this->_providerRepository)) {
            $this->enableRegistryOnObjectNew1($this->_providerRepository);
        }
        return $this;
    }
    ...
    public function setManifestRepository(Zend_Tool_Framework_Manifest_Repository $manifestRepository)
    {
        ...
        if ($this->isObjectNew1RegistryEnablable($this->_manifestRepository)) {
            $this->enableRegistryOnObjectNew1($this->_manifestRepository);
        }
        return $this;
    }
    ...
    /**
     * isObjectNew1RegistryEnablable() - Check whether an object is registry enablable
     *
     * @param object $object
     * @return bool
     */
    public function isObjectNew1RegistryEnablable($object)
    {
        if (!is_object($object)) {
            require_once 'Zend/Tool/Framework/Registry/Exception.php';
            throw new Zend_Tool_Framework_Registry_Exception('isObjectNew1RegistryEnablable() expects an object.');
        }
    ...
    /**
     * enableRegistryOnObjectNew1() - make an object registry enabled
     *
     * @param object $object
     * @return Zend_Tool_Framework_Registry
     */
    public function enableRegistryOnObjectNew1($object)
    {
        if (!$this->isObjectNew1RegistryEnablable($object)) {
            require_once 'Zend/Tool/Framework/Registry/Exception.php';
            throw new Zend_Tool_Framework_Registry_Exception('ObjectNew1 provided is not registry enablable, check first with Zend_Tool_Framework_Registry::isObjectNew1RegistryEnablable()');
        }
