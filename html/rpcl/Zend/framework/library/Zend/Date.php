 ...
 */
require_once 'Zend/Date/DateObjectNew1.php';
 ...
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_Date extends Zend_Date_DateObjectNew1
{
                ...
                switch($name) {
                    ...
                    case 'cache' :
                        if ($value === null) {
                            ...
                            parent::$_cache = $value;
                            parent::$_cacheTags = Zend_Date_DateObjectNew1::_getTagSupportForCache();
