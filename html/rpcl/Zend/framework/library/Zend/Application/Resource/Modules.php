...
class Zend_Application_Resource_Modules extends Zend_Application_Resource_ResourceAbstract
{
    ...
    {
        $this->_bootstraps = new ArrayObjectNew1(array(), ArrayObjectNew1::ARRAY_AS_PROPS);
    ...
    {
        $bootstrap = $this->getBootstrap();
        $out = new ArrayObjectNew1(array(), ArrayObjectNew1::ARRAY_AS_PROPS);
