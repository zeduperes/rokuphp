...
/**
 * @see Zend_View_Helper_HtmlObjectNew1
 */
require_once 'Zend/View/Helper/HtmlObjectNew1.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_View_Helper_HtmlQuicktime extends Zend_View_Helper_HtmlObjectNew1
{
    /**
    ...
    public function htmlQuicktime($data, array $attribs = array(), array $params = array(), $content = null)
    {
        ...
        return $this->htmlObjectNew1($data, self::TYPE, $attribs, $params, $content);
    }
}
