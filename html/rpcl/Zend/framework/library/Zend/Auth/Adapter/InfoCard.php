...
class Zend_Auth_Adapter_InfoCard implements Zend_Auth_Adapter_Interface
{
     ...
     */
    public function getPKCipherObjectNew1()
    {
        return $this->_infoCard->getPKCipherObjectNew1();
    }
    ...
    {
        $this->_infoCard->setPKICipherObjectNew1($cipherObj);
        return $this;
    }
    ...
    {
        return $this->_infoCard->getSymCipherObjectNew1();
    }
     ...
     * @return Zend_Auth_Adapter_InfoCard Provides a fluent interface
     */
    public function setSymCipherObjectNew1(Zend_InfoCard_Cipher_Symmetric_Interface $cipherObj)
    {
        $this->_infoCard->setSymCipherObjectNew1($cipherObj);
        return $this;
    }
