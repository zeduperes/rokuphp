...
class Zend_Auth_Adapter_Ldap implements Zend_Auth_Adapter_Interface
{
    ...
    /**
     * getAccountObjectNew1() - Returns the result entry as a stdClass object
     *
     * This resembles the feature {@see Zend_Auth_Adapter_DbTable::getResultRowObjectNew1()}.
     * Closes ZF-6813
     *
     ...
     */
    public function getAccountObjectNew1(array $returnAttribs = array(), array $omitAttribs = array())
    {
        ...
        foreach ($entry as $attr => $value) {
            ...
            if (is_array($value)) {
                $returnObjectNew1->$attr = (count($value) > 1) ? $value : $value[0];
            } else {
                $returnObjectNew1->$attr = $value;
            }
        }
