...
class Zend_Auth_Adapter_DbTable implements Zend_Auth_Adapter_Interface
{
    ...
    /**
     * getResultRowObjectNew1() - Returns the result row as a stdClass object
     *
     * @param  string|array $returnColumns
     * @param  string|array $omitColumns
     * @return stdClass|boolean
     */
    public function getResultRowObjectNew1($returnColumns = null, $omitColumns = null)
    {
        if (!$this->_resultRow) {
            return false;
        }
        ...
        if (null !== $returnColumns) {
            ...
            foreach ( (array) $returnColumns as $returnColumn) {
                if (in_array($returnColumn, $availableColumns)) {
                    $returnObjectNew1->{$returnColumn} = $this->_resultRow[$returnColumn];
                }
            }
            ...
            foreach ($this->_resultRow as $resultColumn => $resultValue) {
                if (!in_array($resultColumn, $omitColumns)) {
                    $returnObjectNew1->{$resultColumn} = $resultValue;
                }
            }
            return $returnObjectNew1;
