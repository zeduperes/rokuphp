...
class Zend_Service_Amazon_S3_Stream
{
    ...
    public function stream_flush()
    {
        ...
        $ret = $this->_s3->putObjectNew1($this->_objectName, $this->_objectBuffer);
    ...
    {
        return $this->_getS3Client($path)->removeObjectNew1($this->_getNamePart($path));
    }
    ...
    public function dir_opendir($path, $options)
    {
        ...
        if (preg_match('@^([a-z0-9+.]|-)+://$@', $path)) {
            ...
            $this->_bucketList = $this->_getS3Client($path)->getObjectNew1sByBucket($host);
        }
