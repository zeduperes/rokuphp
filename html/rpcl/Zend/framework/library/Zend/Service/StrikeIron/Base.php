...
class Zend_Service_StrikeIron_Base
{
    ...
    {
        $resultObjectNew1Name = "{$method}Result";
        if (isset($result->$resultObjectNew1Name)) {
            $result = $result->$resultObjectNew1Name;
        }
        if (is_object($result)) {
            $result = new Zend_Service_StrikeIron_Decorator($result, $resultObjectNew1Name);
        }
        return $result;
    }
