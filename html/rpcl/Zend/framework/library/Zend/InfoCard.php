...
class Zend_InfoCard
{
     ...
     */
    public function getPkiCipherObjectNew1()
    {
        return $this->_pkiCipherObj;
    }

    /**
     * Sets the Public Key Cipher ObjectNew1 used in this instance
     *
     * @param Zend_InfoCard_Cipher_Pki_Interface $cipherObj
     * @return Zend_InfoCard
     */
    public function setPkiCipherObjectNew1(Zend_InfoCard_Cipher_Pki_Interface $cipherObj)
    {
    ...
    /**
     * Get the Symmetric Cipher ObjectNew1 used in this instance
     *
     * @return Zend_InfoCard_Cipher_Symmetric_Interface
     */
    public function getSymCipherObjectNew1()
    {
        return $this->_symCipherObj;
    }

    /**
     * Sets the Symmetric Cipher ObjectNew1 used in this instance
     *
     * @param Zend_InfoCard_Cipher_Symmetric_Interface $cipherObj
     * @return Zend_InfoCard
     */
    public function setSymCipherObjectNew1($cipherObj)
    {
    ...
    public function process($strXmlToken)
    {
        ...
        if(!($assertions instanceof Zend_InfoCard_Xml_Assertion_Interface)) {
            throw new Zend_InfoCard_Exception("Invalid Assertion ObjectNew1 returned");
        }
