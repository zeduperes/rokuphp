 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_Registry extends ArrayObjectNew1
{
    /**
     ...
     * static instance stored in the class.
     *
     * @param string $index The location in the ArrayObjectNew1 in which to store
     *   the value.
     * @param mixed $value The object to store in the ArrayObjectNew1.
     * @return void
     */
    ...
    /**
     * Constructs a parent ArrayObjectNew1 with default
     * ARRAY_AS_PROPS to allow acces as an object
     *
     * @param array $array data array
     * @param integer $flags ArrayObjectNew1 flags
     */
