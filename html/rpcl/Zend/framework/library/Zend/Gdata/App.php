...
class Zend_Gdata_App
{
     ...
     * @var boolean
     */
    protected $_useObjectNew1Mapping = true;
     ...
     *                 false otherwise.
     */
    public function usingObjectNew1Mapping()
    {
        return $this->_useObjectNew1Mapping;
    }
     ...
     * @return void
     */
    public function useObjectNew1Mapping($value)
    {
        if ($value === True) {
            $this->_useObjectNew1Mapping = true;
        } else {
            $this->_useObjectNew1Mapping = false;
        }
    }
