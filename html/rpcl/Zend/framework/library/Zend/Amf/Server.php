...
class Zend_Amf_Server implements Zend_Server_Interface
{
   ...
   /**
     ...
     *
     * @param string|object $object ObjectNew1 or class being accessed
    ...
    protected function _handle(Zend_Amf_Request $request)
    {
        ...
        $objectEncoding = $request->getObjectNew1Encoding();

        // create a response object to place the output from the services.
        $response = $this->getResponse();

        // set response encoding
        $response->setObjectNew1Encoding($objectEncoding);
