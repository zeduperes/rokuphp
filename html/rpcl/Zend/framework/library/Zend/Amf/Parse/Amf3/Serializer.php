...
class Zend_Amf_Parse_Amf3_Serializer extends Zend_Amf_Parse_Serializer
{
    ...
    {
        if ($this->writeObjectNew1Reference($data)) {
            return $this;
        }
    ...
    {
        if ($this->writeObjectNew1Reference($xml)) {
            return $this;
        }
    ...
    {
        if ($this->writeObjectNew1Reference($date)) {
            return $this;
        }
    ...
    public function writeArray(&$array)
    {
        ...
        $this->_referenceObjectNew1s[] = $array;
     ...
     */
    protected function writeObjectNew1Reference(&$object, $objectByVal = false)
    {
        // Workaround for PHP5 with E_STRICT enabled complaining about "Only
        // variables should be passed by reference"
        ...
        $ref = array_key_exists($hash, $this->_referenceObjectNew1s) 
             ? $this->_referenceObjectNew1s[$hash] 
             : false;
        ...
        $this->_referenceObjectNew1s[$hash] = count($this->_referenceObjectNew1s);
        return false;
    }
     ...
     * @return Zend_Amf_Parse_Amf3_Serializer
     */
    public function writeObjectNew1($object)
    {
        if($this->writeObjectNew1Reference($object)){
            return $this;
        }
        ...
        try {
            switch($encoding) {
                ...
                case Zend_Amf_Constants::ET_EXTERNAL:
                    require_once 'Zend/Amf/Exception.php';
                    throw new Zend_Amf_Exception('External ObjectNew1 Encoding not implemented');
                    break;
                default:
                    require_once 'Zend/Amf/Exception.php';
                    throw new Zend_Amf_Exception('Unknown ObjectNew1 Encoding type: ' . $encoding);
            }
        } catch (Exception $e) {
            require_once 'Zend/Amf/Exception.php';
            throw new Zend_Amf_Exception('Unable to writeObjectNew1 output: ' . $e->getMessage(), 0, $e);
        }
