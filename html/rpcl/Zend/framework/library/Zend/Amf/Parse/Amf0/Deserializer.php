 ...
 *
 * @todo       Implement Typed ObjectNew1 Class Mapping
...
class Zend_Amf_Parse_Amf0_Deserializer extends Zend_Amf_Parse_Deserializer
{
    ...
    public function readTypeMarker($typeMarker = null)
    {
        ...
        switch($typeMarker) {
            ...
            case Zend_Amf_Constants::AMF0_TYPEDOBJECT:
                return $this->readTypedObjectNew1();
     ...
     * @return object
     */
    public function readObjectNew1($object = null)
    {
        if ($object === null) {
            $object = array();
        }
     ...
     *
     * Commonly used for Value ObjectNew1s on the server
     *
     * @todo   implement Typed Class mapping
     * @return object|array
     * @throws Zend_Amf_Exception if unable to load type
     */
    public function readTypedObjectNew1()
    {
        ...
        $properties = get_object_vars($this->readObjectNew1());
     ...
     * @return int
     */
    public function getObjectNew1Encoding()
    {
