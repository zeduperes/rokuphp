...
abstract class Zend_Barcode_Renderer_RendererAbstract
{
    ...
    /**
     * Barcode object
     * @var Zend_Barcode_ObjectNew1_ObjectNew1Abstract
     */
    protected $_barcode;
     ...
     * @param  array $options
     * @return Zend_Renderer_ObjectNew1
     */
     ...
     * @param Zend_Barcode_ObjectNew1 $barcode
     * @return Zend_Barcode_Renderer
     */
     ...
     * @throw Zend_Barcode_Renderer_Exception
     */
    protected function _checkBarcodeObjectNew1()
    {
