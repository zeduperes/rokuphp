 ...
 * @version    $Id: ObjectNew1Abstract.php 23775 2011-03-01 17:25:24Z ralph $
 */
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class Zend_Barcode_ObjectNew1_ObjectNew1Abstract
{
    /**
     * Namespace of the barcode for autoloading
     * @var string
     */
    protected $_barcodeNamespace = 'Zend_Barcode_ObjectNew1';
     ...
     * @param integer $value
     * @return Zend_Barcode_ObjectNew1
     * @throw Zend_Barcode_ObjectNew1_Exception
     */
    public function setBarHeight($value)
    {
        if (intval($value) <= 0) {
            require_once 'Zend/Barcode/ObjectNew1/Exception.php';
            throw new Zend_Barcode_ObjectNew1_Exception(
    ...
    public function setFont($value)
    {
        if (is_int($value) && $value >= 1 && $value <= 5) {
            ...
            require_once 'Zend/Barcode/ObjectNew1/Exception.php';
            throw new Zend_Barcode_ObjectNew1_Exception(sprintf(
    ...
    protected function _validateText($value, $options = array())
    {
        ...
        if (!$validator->isValid($value)) {
            ...
            /**
             * @see Zend_Barcode_ObjectNew1_Exception
             */
            require_once 'Zend/Barcode/ObjectNew1/Exception.php';
            throw new Zend_Barcode_ObjectNew1_Exception($message);
        }
    }
