...
class Zend_Barcode
{
     ...
     * name, e.g. 'int25' corresponds to class Zend_Barcode_ObjectNew1_Int25.  This
     * is case-insensitive.
     *
     ...
     * @param mixed $barcode        String name of barcode class, or Zend_Config object.
     * @param mixed $barcodeConfig  OPTIONAL; an array or Zend_Config object with barcode parameters.
     * @return Zend_Barcode_ObjectNew1
     */
    public static function makeBarcode($barcode, $barcodeConfig = array())
    {
        if ($barcode instanceof Zend_Barcode_ObjectNew1_ObjectNew1Abstract) {
            return $barcode;
        }
         ...
         */
        $barcodeNamespace = 'Zend_Barcode_ObjectNew1';
         ...
         */
        if (!$bcAdapter instanceof Zend_Barcode_ObjectNew1_ObjectNew1Abstract) {
            /**
             * @see Zend_Barcode_Exception
             */
            require_once 'Zend/Barcode/Exception.php';
            throw new Zend_Barcode_Exception(
                "Barcode class '$barcodeName' does not extend Zend_Barcode_ObjectNew1_ObjectNew1Abstract"
            );
        }
        return $bcAdapter;
    }
     ...
     *
     * @param string | Zend_Barcode_ObjectNew1 | array | Zend_Config $barcode
    ...
    /**
     * Proxy for setBarcodeFont of Zend_Barcode_ObjectNew1
     * @param string $font
     * @eturn void
     */
    public static function setBarcodeFont($font)
    {
        ...
        Zend_Barcode_ObjectNew1_ObjectNew1Abstract::setBarcodeFont($font);
    }
}
