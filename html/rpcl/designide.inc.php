 ...
 * @param array $values Array of valid values will be shown in the ObjectNew1 Inspector
 */
...
/**
 * Registers a boolean property, so the ObjectNew1 Inspector offers a true/false dropdown
 *
 * <code>
 * <?php
...
/**
 * Registers a password property, so the ObjectNew1 Inspector doesn't show the value
 ...
 *
 */
class ComponentEditor extends ObjectNew1
{
