<?php
	...
	*/
	...
	$req_Mv_Mo = $xajax->register(XAJAX_FUNCTION, 'modifyValue', array('context' => 'myObjectNew1', 'alias' => 'modifyValue_myObjectNew1'));
	$req_Cf_Mo = $xajax->register(XAJAX_FUNCTION, 'callFunction', array('context' => 'myObjectNew1', 'alias' => 'callFunction_myObjectNew1'));
...
?>
		<script type="text/javascript">
			...
			myObjectNew1 = { value: 1000 };
			myObjectNew1.myFunction = function() {
				writeToLog('myObjectNew1.myFunction called');
				if (0 < arguments.length) {
				    writeToLog(' with ', arguments.length, ' arguments:');
				    for (var argName = 0; argName < arguments.length; ++argName) {
				        writeToLog(' [', argName, ':');
			...
			myObjectNew1.logValue = function() {
				writeToLog('Value updated: ', this.value, '<br />');
			}
			myObjectNew1.callFunction = function() {
			...
			<div class='controlPanel_row'>
				...
				<div class='controlPanel_cell'>
					<input type='submit' value='Call Function (alt method)' 
						onclick='xajax.$("log").innerHTML += "Calling method (alternate method)<br />"; myObjectNew1.callFunction(); return false;' />
				</div>
				<div class='endRow'></div>
			</div>
			<div class='controlPanel_row'>
