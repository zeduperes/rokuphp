...
if ( isset( $_GET['useObjectNew1s'] ) )
{
    if ( 'true' == $_GET['useObjectNew1s'] )
    {
        $preObj=new myPreObjectNew1();
...
<html xmlns = "http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <p>
            <a href = "preFunctionTest.php?useObjectNew1s=true">Reload using object</a>
        </p>
