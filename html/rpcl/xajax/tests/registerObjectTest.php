<?php
/*
    File: registerObjectNew1Test.php
...
/*
    @package xajax
    @version $Id: registerObjectNew1Test.php 362 2007-05-29 15:32:24Z calltoconstruct $
    @copyright Copyright (c) 2005-2006 by Jared White & J. Max Wilson
    @license http://www.xajaxproject.org/bsd_license.txt BSD License
*/
require_once( "../xajax_core/xajax.inc.php" );

class myObjectNew1Test
{
    var $myValue='default';
...
<html xmlns = "http://www.w3.org/1999/xhtml" xml:lang = "en" lang = "en">
    <head>
        <title>Register ObjectNew1 Test | xajax Tests</title>
