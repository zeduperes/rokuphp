<?php
/*
	File: xajaxCallableObjectNew1.inc.php

	Contains the xajaxCallableObjectNew1 class

	Title: xajaxCallableObjectNew1 class
...
/*
	@package xajax
	@version $Id: xajaxCallableObjectNew1.inc.php 362 2007-05-29 15:32:24Z calltoconstruct $
...
/*
	...
	<xajaxCallableObjectNew1->generateClientScript> so that stub functions can be 
...
class xajaxCallableObjectNew1
{
	...
	*/
	...
	/*
		Function: xajaxCallableObjectNew1
		
		Constructs and initializes the <xajaxCallableObjectNew1>
		
		obj - (object):  The object to reference.
	*/
	function xajaxCallableObjectNew1(&$obj)
	{
		$this->obj =& $obj;
	...
	*/
	...
	/*
		...
		sXajaxPrefix - (string):  The prefix to be prepended to the
			...
			<xajaxCallableObjectNew1->generateClientScript> call.
	*/
	...
	/*
		...
		Called by <xajaxCallableObjectNew1->generateClientScript> while <xajax> is 
	...
	*/	
	...
	/*
		...
		object referenced by <xajaxCallableObjectNew1->obj>.
