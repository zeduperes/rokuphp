...
return r;}catch(e){var msg='ObjectNew1ToXML: ';msg+=xajax.debug.getExceptionText(e);msg+='\n';xajax.debug.writeMessage(msg,xajax.debug.text[101],'errorText');}
return '';}
...
xajax.debug.getRequestObjectNew1=xajax.tools.getRequestObjectNew1;xajax.tools.getRequestObjectNew1=function(){try{xajax.debug.writeMessage(xajax.debug.text[127]);return xajax.debug.getRequestObjectNew1();}catch(e){var msg='GetRequestObjectNew1: ';msg+=xajax.debug.getExceptionText(e);msg+='\n';xajax.debug.writeMessage(msg,xajax.debug.text[101],'errorText');throw e;}
}
