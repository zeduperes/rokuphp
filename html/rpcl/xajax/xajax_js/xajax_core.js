...
});xajax.config.setDefault('postHeaders',{});xajax.config.setDefault('getHeaders',{});xajax.config.setDefault('waitCursor',false);xajax.config.setDefault('statusMessages',false);xajax.config.setDefault('baseDocument',document);xajax.config.setDefault('requestURI',xajax.config.baseDocument.URL);xajax.config.setDefault('defaultMode','asynchronous');xajax.config.setDefault('defaultHttpVersion','HTTP/1.1');xajax.config.setDefault('defaultContentType','application/x-www-form-urlencoded');xajax.config.setDefault('defaultResponseDelayTime',1000);xajax.config.setDefault('defaultExpirationTime',10000);xajax.config.setDefault('defaultMethod','POST');xajax.config.setDefault('defaultRetry',5);xajax.config.setDefault('defaultReturnValue',false);xajax.config.setDefault('maxObjectNew1Depth',20);xajax.config.setDefault('maxObjectNew1Size',2000);xajax.config.setDefault('responseQueueSize',1000);xajax.config.status={update:function(){return{onRequest:function(){window.status='Sending Request...';},
...
xajax.tools._nodeToObjectNew1=function(node){if(null==node)
return '';if('undefined'!=typeof node.nodeName){if('#cdata-section'==node.nodeName||'#text'==node.nodeName){var data='';do if(node.data)data+=node.data;while(node=node.nextSibling);return xajax.tools._enforceDataType(data);}else if('xjxobj'==node.nodeName){var key=null;var value=null;var data=new Array;var child=node.firstChild;while(child){if('e'==child.nodeName){var grandChild=child.firstChild;while(grandChild){if('k'==grandChild.nodeName)
key=xajax.tools._enforceDataType(grandChild.firstChild.data);else('v'==grandChild.nodeName)
value=xajax.tools._nodeToObjectNew1(grandChild.firstChild);grandChild=grandChild.nextSibling;}
...
xajax.tools.getRequestObjectNew1=function(){if('undefined'!=typeof XMLHttpRequest){xajax.tools.getRequestObjectNew1=function(){return new XMLHttpRequest();}
}else if('undefined'!=typeof ActiveXObjectNew1){xajax.tools.getRequestObjectNew1=function(){try{return new ActiveXObjectNew1('Msxml2.XMLHTTP.4.0');}catch(e){xajax.tools.getRequestObjectNew1=function(){try{return new ActiveXObjectNew1('Msxml2.XMLHTTP');}catch(e2){xajax.tools.getRequestObjectNew1=function(){return new ActiveXObjectNew1('Microsoft.XMLHTTP');}
return xajax.tools.getRequestObjectNew1();}
}
return xajax.tools.getRequestObjectNew1();}
}
}else if(window.createRequest){xajax.tools.getRequestObjectNew1=function(){return window.createRequest();}
}else{xajax.tools.getRequestObjectNew1=function(){throw{code:10002};}
}
return xajax.tools.getRequestObjectNew1();}
...
}while(grandChild=grandChild.nextSibling);}else{var grandChild=child.firstChild;if('xjxobj'==grandChild.nodeName){obj.data=xajax.tools._nodeToObjectNew1(grandChild);return;}else if('#cdata-section'==grandChild.nodeName||'#text'==grandChild.nodeName){obj.data=grandChild.data;}
}
}else if('undefined'!=typeof child.data){obj.data=child.data;}
obj.data=xajax.tools._enforceDataType(obj.data);}
xajax.tools.xml.processFragment=function(xmlNode,seq,oRet,oRequest){var xx=xajax;var xt=xx.tools;while(xmlNode){if('cmd'==xmlNode.nodeName){var obj={};obj.fullName='*unknown*';obj.sequence=seq;obj.request=oRequest;obj.context=oRequest.context;xt.xml.parseAttributes(xmlNode,obj);xt.xml.parseChildren(xmlNode,obj);xt.queue.push(xx.response,obj);}else if('xjxrv'==xmlNode.nodeName){oRet=xt._nodeToObjectNew1(xmlNode.firstChild);}else if('debugmsg'==xmlNode.nodeName){}else
...
oRequest.set('statusMessages',xc.statusMessages);oRequest.set('waitCursor',xc.waitCursor);oRequest.set('mode',xc.defaultMode);oRequest.set('method',xc.defaultMethod);oRequest.set('URI',xc.requestURI);oRequest.set('httpVersion',xc.defaultHttpVersion);oRequest.set('contentType',xc.defaultContentType);oRequest.set('retry',xc.defaultRetry);oRequest.set('returnValue',xc.defaultReturnValue);oRequest.set('maxObjectNew1Depth',xc.maxObjectNew1Depth);oRequest.set('maxObjectNew1Size',xc.maxObjectNew1Size);oRequest.set('context',window);var xcb=xx.callback;var gcb=xcb.global;var lcb=xcb.create();lcb.take=function(frm,opt){if('undefined'!=typeof frm[opt]){lcb[opt]=frm[opt];lcb.hasEvents=true;}
delete frm[opt];}
...
var dNow=new Date();rd.push('&xjxr=');rd.push(dNow.getTime());delete dNow;if(oRequest.parameters){var i=0;var iLen=oRequest.parameters.length;while(i < iLen){var oVal=oRequest.parameters[i];if('object'==typeof oVal&&null!=oVal){try{var oGuard={};oGuard.depth=0;oGuard.maxDepth=oRequest.maxObjectNew1Depth;oGuard.size=0;oGuard.maxSize=oRequest.maxObjectNew1Size;oVal=xt._objectToXML(oVal,oGuard);}catch(e){oVal='';}
...
xajax.prepareRequest=function(oRequest){var xx=xajax;var xt=xx.tools;oRequest.request=xt.getRequestObjectNew1();oRequest.setRequestHeaders=function(headers){if('object'==typeof headers){for(var optionName in headers)
