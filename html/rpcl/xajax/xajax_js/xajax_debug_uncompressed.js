...
try
{
	...
	*/
	...
	xajax.debug.exceptions[10002] = 'GetRequestObjectNew1: XMLHttpRequest is not available, xajax is disabled.';
	...
	*/
	...
	/*
		...
		This is a wrapper around the standard <xajax.getRequestObjectNew1>
		function.
	*/
	xajax.debug.getRequestObjectNew1 = xajax.tools.getRequestObjectNew1;
	xajax.tools.getRequestObjectNew1 = function() {
		try {
			xajax.debug.writeMessage(xajax.debug.text[127]);
			return xajax.debug.getRequestObjectNew1();
		} catch (e) {
			var msg = 'GetRequestObjectNew1: ';
			msg += xajax.debug.getExceptionText(e);
			msg += '\n';
			xajax.debug.writeMessage(msg, xajax.debug.text[101], 'errorText');
			throw e;
