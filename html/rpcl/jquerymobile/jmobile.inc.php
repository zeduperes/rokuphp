...
class CustomMDateTimePicker extends CustomMEdit
{
    ...
    */
    function dumpHeaderCode()
    {
            ...
            {
                ?>
                <link rel="stylesheet" type="text/javascript" href="<?php echo MOBILE_RPCL_PATH ?>/jquerymobile/css/jqm-datebox-1.1.0.css"/>
                <script type="text/javascript" src="<?php echo MOBILE_RPCL_PATH ?>/jquerymobile/js/jqm-datebox-1.1.0.core.js" charset="UTF-8"></script>
                <script type="text/javascript" src="<?php echo MOBILE_RPCL_PATH ?>/jquerymobile/js/jqm-datebox-1.1.0.mode.calbox.js" charset="UTF-8"></script>
                <script type="text/javascript" src="<?php echo MOBILE_RPCL_PATH ?>/jquerymobile/js/jqm-datebox-1.1.0.mode.datebox.js" charset="UTF-8"></script>
                <script type="text/javascript" src="<?php echo MOBILE_RPCL_PATH ?>/jquerymobile/js/jqm-datebox-1.1.0.mode.durationbox.js" charset="UTF-8"></script>
                <script type="text/javascript" src="<?php echo MOBILE_RPCL_PATH ?>/jquerymobile/js/jqm-datebox-1.1.0.mode.flipbox.js" charset="UTF-8"></script>
                <script type="text/javascript" src="<?php echo MOBILE_RPCL_PATH ?>/jquerymobile/js/jqm-datebox-1.1.0.mode.slidebox.js" charset="UTF-8"></script>
    ...
    function dumpAdditionalCSS()
    {
        ...
        parent::dumpAdditionalCSS();
        echo  $this->readCSSDescriptor()."_outer > .ui-input-datebox{ \n";
        echo "width: 100%;\n";
        echo "height: 100%;\n";
        echo "box-sizing: border-box;\n";
        parent::dumpCSS();
