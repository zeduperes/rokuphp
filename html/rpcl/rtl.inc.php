...
*
*
* @param object $var ObjectNew1 to check
* @return boolean
*/
...
* @see safeunserialize()
*
* @param string $sObjectNew1 String to unserialize
* @return mixed
*/
function __unserialize($sObjectNew1)
{
    $__ret =preg_replace('!s:(\d+):"(.*?)";!e', "'s:'.strlen('$2').':\"$2\";'", $sObjectNew1 );
